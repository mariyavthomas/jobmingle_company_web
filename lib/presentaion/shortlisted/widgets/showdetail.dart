...
void showCandidateDetails(
    BuildContext context, ShortListCandidatesModel candidate) {
                      ...
                      children: [
                        ElevatedButton(
                          ...
                          onPressed: () async {
                            ShortListCandidatesModel shortlistmodel =
                              ...
                              companyphonenumber: candidate.companyphonenumber,
                              ...
                              userhigereducation: candidate.userhigereducation,
                              ...
                              userprofilesummery: candidate.userprofilesummery,
                              ...
                              usercurrentjobrole: candidate.usercurrentjobrole,
                            );
                            ...
                            final querySnapshot = await FirebaseFirestore
                                ...
                                .where('appyuid', isEqualTo: candidate.appyuid)
                                .get();
                            ...
                            if (querySnapshot.docs.isNotEmpty) {
                              ...
                              context.read<ShortlistedCandidateBloc>().add(
                                  AddedtoShortList(shortlist: shortlistmodel));
                              TopNotification.show(
                                  context, "Shortlisted", CustomColor.green());
                            }
                          },
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            if (querySnapshot.docs.isNotEmpty) {
                              TopNotification.show(context, "Already Rejected",
                                  CustomColor.red());
                            } else {
